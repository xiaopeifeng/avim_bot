...
namespace av_router {
	...
	//  }
	// @end example
#ifndef AVROUTER_LOG_FILE_NUM
#	define AVROUTER_LOG_FILE_NUM 3
#endif

#ifndef AVROUTER_LOG_FILE_BUFFER
#	define AVROUTER_LOG_FILE_BUFFER -1
#endif
...
#	define LOGGER_DBG_VIEW_(x) ((void)0)
	...
	public:
		...
		~logger()
		{
			...
			logger_writer(level_, message, disable_cout_);
		}
